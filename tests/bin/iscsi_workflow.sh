...
helm install kolla/ironic-create-db-job --version $VERSION \
    --namespace kolla --name ironic-create-db \
    --values /tmp/general_config.yaml --values /tmp/iscsi_config.yaml

helm install kolla/ironic-manage-db-job --version $VERSION \
    --namespace kolla --name ironic-manage-db \
    --values /tmp/general_config.yaml --values /tmp/iscsi_config.yaml

helm install kolla/ironic-create-keystone-endpoint-internal-job --version $VERSION \
    --namespace kolla --name ironic-create-keystone-endpoint-internal \
    --values /tmp/general_config.yaml --values /tmp/iscsi_config.yaml

helm install kolla/ironic-create-keystone-endpoint-admin-job --version $VERSION \
    --namespace kolla --name ironic-create-keystone-endpoint-admin \
    --values /tmp/general_config.yaml --values /tmp/iscsi_config.yaml

helm install kolla/ironic-create-keystone-endpoint-public-job --version $VERSION \
