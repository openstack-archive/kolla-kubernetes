...
for x in nova-api nova-conductor nova-consoleauth \ #nova-scheduler
...
kollakube res create pod nova-scheduler
...
kollakube res create pod nova-libvirt nova-compute
