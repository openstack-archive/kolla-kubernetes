...
[ -d "$WORKSPACE/logs" ] && echo "1" >> $WORKSPACE/logs/rabbitmq-debug.log \
&& kubectl get jobs --namespace=kolla >> $WORKSPACE/logs/rabbitmq-debug.log

helm ls | grep rabbitmq-job | awk '{print "helm delete "$1}' | sh -l || true

[ -d "$WORKSPACE/logs" ] && echo "2" >> $WORKSPACE/logs/rabbitmq-debug.log \
&& kubectl get jobs --namespace=kolla >> $WORKSPACE/logs/rabbitmq-debug.log

kubectl get job --namespace=kolla | grep rabbitmq | awk '{print "kubectl delete job "$1" --namespace=kolla"}' | sh -l

[ -d "$WORKSPACE/logs" ] && echo "3" >> $WORKSPACE/logs/rabbitmq-debug.log \
&& kubectl get jobs --namespace=kolla >> $WORKSPACE/logs/rabbitmq-debug.log

kollakube res delete bootstrap rabbitmq-bootstrap

[ -d "$WORKSPACE/logs" ] && echo "4" >> $WORKSPACE/logs/rabbitmq-debug.log \
&& kubectl get jobs --namespace=kolla >> $WORKSPACE/logs/rabbitmq-debug.log
...
[ -d "$WORKSPACE/logs" ] && echo "5" >> $WORKSPACE/logs/rabbitmq-debug.log \ 
&& kubectl get pods --namespace=kolla >> $WORKSPACE/logs/rabbitmq-debug.log

[ -d "$WORKSPACE/logs" ] && echo "6" >> $WORKSPACE/logs/rabbitmq-debug.log \
&& kubectl describe pod rabbitmq-0 --namespace=kolla || true >> $WORKSPACE/logs/rabbitmq-debug.log
