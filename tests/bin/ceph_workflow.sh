...
helm install --debug --dry-run kolla/keystone-create-db --version 3.0.0-1 \
    --namespace kolla \
...
echo "DEBUG: kollakube keystone manage db template"
kollakube resource create bootstrap keystone-manage-db

echo "DEBUG: dumping helm keystone manage db template"
helm install --debug --dry-run kolla/keystone-manage-db --version 3.0.0-1 \
    --namespace kolla \
