...
helm install kolla/keystone-public-svc --version 3.0.0-1 \
    ...
    --set "element_name=keystone-public,element_port_external=true,external_vip=$IP"
...
helm install kolla/glance-api-svc --version 3.0.0-1 \
    ...
    --set "element_port_external=true,external_vip=$IP"
...
helm install kolla/cinder-api-svc --version 3.0.0-1 \
    ...
    --set "element_name=cinder,element_port_external=true,external_vip=$IP"

helm install kolla/nova-api-svc --version 3.0.0-1 \
    --namespace kolla --name nova-api-svc \
    --set "element_name=nova,element_port_external=true,external_vip=$IP"
...
helm install kolla/heat-api-svc --version 3.0.0-1 \
    ...
    --set "element_name=heat,element_port_external=true,external_vip=$IP"

helm install kolla/heat-cfn-api-svc --version 3.0.0-1 \
    --namespace kolla --name heat-cfn-api-svc \
    --set "element_name=heat-cfn,element_port_external=true,external_vip=$IP"
