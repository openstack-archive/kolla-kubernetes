function common_iscsi_config {
    ...
    echo "      manage_db:"
    echo "        job:"
    echo "          image_full: docker.io/sbezverk/centos-source-cinder-api:4.0.3"
    echo "      volume_lvm:"
    echo "        daemonset:"
    echo "          element_name: cinder-volume"
    echo "          image_full: docker.io/sbezverk/centos-source-cinder-volume:4.0.3"
    echo "      scheduler:"
    echo "        statefulset:"
    echo "          image_full: docker.io/sbezverk/centos-source-cinder-scheduler:4.0.3"
    echo "      api:"
    echo "        all:"
