function common_iscsi_config {
    ...
    echo "      manage_db:"
    echo "        job:"
    echo "          image_full: docker.io/kolla/centos-source-cinder-api:4.0.2"
    echo "      volume_lvm:"
    echo "        daemonset:"
    echo "          element_name: cinder-volume"
    echo "          image_full: docker.io/kolla/centos-source-cinder-volume:4.0.2"
    echo "      scheduler:"
    echo "        statefulset:"
    echo "          image_full: docker.io/kolla/centos-source-cinder-scheduler:4.0.2"
    echo "      api:"
    echo "        all:"
