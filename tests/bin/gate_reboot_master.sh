...
. ~/keystonerc_admin
set -x
kubectl delete pod -f ceph-osd0 --namespace kolla
kubectl delete pod -f ceph-osd1 --namespace kolla
kubectl delete pod -f ceph-admin --namespace kolla
sleep 160 #FIXME wait for pods to delete...
