...
helm install kolla/placement-api-svc --dry-run --debug --version $VERSION \
...
helm install kolla/placement-api-create-keystone-service-job --dry-run --debug --version $VERSION \
...
helm install kolla/placement-api-create-keystone-user-job --dry-run --debug --version $VERSION \
...
helm install kolla/placement-api-create-keystone-endpoint-public-job --dry-run --debug --version $VERSION \
...
helm install kolla/placement-api-create-keystone-endpoint-internal-job --dry-run --debug --version $VERSION \
    --namespace kolla --name placement-api-create-keystone-endpoint-internal \
    --values /tmp/general_config.yaml --values /tmp/iscsi_config.yaml

helm install kolla/placement-api-create-keystone-endpoint-admin-job --dry-run --debug --version $VERSION \
