...
if [ "x$DISTRO" == "xcentos" ]; then
    ...
    sudo chmod --recursive 664 $WORKSPACE/UPLOAD_REPOS/kubernetes/
    sudo chmod 775 $WORKSPACE/UPLOAD_REPOS/kubernetes/packages
    sudo chmod 775 $WORKSPACE/UPLOAD_REPOS/kubernetes
    sudo find $WORKSPACE/UPLOAD_REPOS/kubernetes
