...
CONFIG_SEARCH_PATHS = [
    ...
    os.path.abspath(os.path.join(PathFinder.find_project_root(), '../kolla/etc/kolla')),
    os.path.abspath(os.path.join(PathFinder.find_project_root(), 'etc/kolla-kubernetes')),
]
