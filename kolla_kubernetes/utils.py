...
# Disable yaml printing of aliases and anchors
...
class YamlUtils(object):
    ...
    def yaml_dict_to_string_jinja(dict_):
        ...
        If you use the normal style instead of double-quote style,
        then yaml dump will escape all single quotes (') by doubling
        them up ('').  If jinja is to process the string, it will
        fail.  Thus, change the quote style to avoid escaping single
        quote (')
        """
        # Use width=1000000 to prevent wrapping
