...
def generate_RSA(bits=4096):
    ...
    # we strip trailing space for 1:1 compat with previous pycrypto implementation
    private_key = new_key.private_bytes(encoding=Encoding.PEM,
                                        format=PrivateFormat.TraditionalOpenSSL,
                                        encryption_algorithm=NoEncryption()).strip()
