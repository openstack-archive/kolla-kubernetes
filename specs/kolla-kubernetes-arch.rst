...
to handle running a series of tasks in a certain order.  Kubernetes does not
natively support worflow operations.
...
use layer 3 for upgrades or other lifecycle operations.
  ...
  | |     Container   | |         - The Dependency Init Container checks to be
...
Kolla-kubernetes Design Options
===============================
