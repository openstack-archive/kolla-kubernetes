...
services.  There will be pauses in between commands to ensure they are
completed.
...
.. NOTE:: petsets are not deleted on delete currently. The resources for it will have to be cleaned up by hand.
