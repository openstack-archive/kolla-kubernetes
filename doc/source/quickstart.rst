...
`The Kolla documentation engine has a more detailed overview of building the
containers<http://docs.openstack.org/developer/kolla/image-building.html>`_ but, these
steps should get you moving:
