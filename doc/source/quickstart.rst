...
Kolla can generate configs if you wish using `./tools/kolla-ansible genconfig` 
from the Kolla directory.  The config files will be populated based on what's 
in globals.yml and passwords.yml then placed in /etc/kolla
