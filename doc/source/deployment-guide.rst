...
this command, reboot, and run these commands again::
    ...
    sudo tools/cleanup-k8s-15.sh

.. warning::

   If switching CNI drivers, the above command is mandatory as CNI litters
   /opt with runtime data.

.. warning::

   The above action is **destructive** in nature, and should be used with
   caution.
