...
.. note::
   ...
   services.  These instrucitons change the default that kubeadm uses which
...
.. note::
   ...
   If nslookup kubernetes failsk, kolla-kubernetes will not deploy correctly.
   If this occurs stop here and seek further assistance from the Kubernetes
   or Kolla communities.
...
Add this content to the end of /etc/kolla/globals.yml::
    ...
    # TODO (sdake) Figure out what to set this to
