...
# NOTE(sambetts) We need to make sure kolla-kubernetes is pip installed
...
install_reqs () {
  if [ -f /etc/redhat-release ]; then
      ...
      # NOTE(sambetts) Kill iscsi packages
      #for PACKAGE in iscsi-initiator-utils; do
...
setup_node_labels () {
  ...
  # NOTE(sambetts) I think this is trying to tag the master node
