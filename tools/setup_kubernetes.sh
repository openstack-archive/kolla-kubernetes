...
#             These RPMS were generated by Google and signed appropriately.  A
#             community member provided the original RPMs from their Pulp mirror
#             here:
#                 https://github.com/kubernetes/kubernetes/issues/43819#issuecomment-290692364
#             I then scp'ed them them to fedorapeople.org

# Validate the RPM signatures for downloads from fedorapeople.org
