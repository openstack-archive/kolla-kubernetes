...
kubeadm init --skip-preflight-checks --use-kubernetes-version v1.6.0 --service-cidr 172.16.128.0/24 --api-advertise-addresses $(cat /etc/nodepool/primary_node_private) | tee /tmp/kubeout
