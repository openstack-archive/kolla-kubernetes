...
MountFlags=shared
EOF
sudo mv /tmp/$$ /etc/systemd/system/docker.service.d/shared.conf
...
sed -i 's|KUBELET_KUBECONFIG_ARGS=|KUBELET_KUBECONFIG_ARGS=--feature-gates=MountPropagation=true |g' \
