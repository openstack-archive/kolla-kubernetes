...
def usage():
    print("wait_for_pods.py requires two arguments.  a list of comma \
           separated pod prefixes to monitor and a comma separated list \
           of valid end states to wait for (such as completed and running)")
    return
