...
common_create_keystone_admin = [
    ...
    'placement-api-create-keystone-user-job',
    'placement-api-create-keystone-service-job',
    'placement-api-create-keystone-endpoint-public-job',
    'placement-api-create-keystone-endpoint-internal-job',
    'placement-api-create-keystone-endpoint-admin-job',
