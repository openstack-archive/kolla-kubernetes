...
kolla-kubernetes resource create bootstrap mariadb-bootstrap rabbitmq-bootstrap

pull_containers kolla
wait_for_pods kolla

#FIXME fail here to see whats happening.
ls -lad /var/lib/kolla/volumes/rabbitmq
ls -lad /var/lib/kolla/volumes/rabbitmq/*
trap_error
