...
grep api_interface_address ../kolla-ansible/etc/kolla/globals.yml || echo api_interface_address: "0.0.0.0" >> ../kolla-ansbile/etc/kolla/globals.yml
grep tunnel_interface_address ../kolla-ansible/etc/kolla/globals.yml || echo tunnel_interface_address: "0.0.0.0" >> ../kolla-ansbile/etc/kolla/globals.yml
grep orchestration_engine ../kolla-ansbile/etc/kolla/globals.yml || echo orchestration_engine: KUBERNETES >> ../kolla-ansible/etc/kolla/globals.yml
