#!/bin/bash
[ ! -d ../kolla-ansible ] && pushd .. && git clone https://github.com/openstack/kolla-ansible && popd
grep api_interface_address ../kolla-ansible/etc/kolla/globals.yml || echo api_interface_address: "0.0.0.0" >> ../kolla-ansible/etc/kolla/globals.yml
grep tunnel_interface_address ../kolla-ansible/etc/kolla/globals.yml || echo tunnel_interface_address: "0.0.0.0" >> ../kolla-ansible/etc/kolla/globals.yml
grep orchestration_engine ../kolla-ansible/etc/kolla/globals.yml || echo orchestration_engine: KUBERNETES >> ../kolla-ansible/etc/kolla/globals.yml

cat ../kolla-ansible/etc/kolla/globals.yml
...
python setup.py test  --testr-args="$1"
